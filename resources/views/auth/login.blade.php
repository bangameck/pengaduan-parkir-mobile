<x-guest-layout>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-100 px-4">
        {{-- Logo dan Subtitle --}}
        <div class="mb-6 text-center">
            ...
            <p class="mt-4 text-gray-600 font-semibold">
                Selamat Datang di Aplikasi Pengaduan Parkir, Silahkan Login!
            </p>
        </div>

        <div class="w-full" x-data="{ showPassword: false, isSubmitting: false }">
