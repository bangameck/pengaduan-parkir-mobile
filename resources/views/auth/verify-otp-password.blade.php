<x-guest-layout>
    <div x-data="otpForm('{{ route('otp.resend', $user->username) }}')">
        {{-- Judul & Subjudul --}}
        <h1 class="auth-title text-center">Verifikasi Kode OTP</h1>
        ...
        {{-- Form OTP --}}
        <form method="POST" action="{{ route('password.otp.confirm') }}" class="mt-6" x-ref="otpForm" @submit="isSubmitting = true">
            @csrf
